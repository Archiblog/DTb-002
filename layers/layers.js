...
var lyr_FacultyAreas_5 = new ol.layer.Vector({
        ...
        var lyr_OpenRailWayMapStandard_6 = new ol.layer.Tile({
...
lyr_OSMStandard_0.setVisible(true);lyr_AllareasKmltoshapefile_1.setVisible(true);lyr_DTbserviceroads_2.setVisible(true);lyr_DTbservicerailways_3.setVisible(true);lyr_TransferAreas_4.setVisible(true);lyr_FacultyAreas_5.setVisible(true);lyr_OpenRailWayMapStandard_6.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_AllareasKmltoshapefile_1,lyr_DTbserviceroads_2,lyr_DTbservicerailways_3,lyr_TransferAreas_4,lyr_FacultyAreas_5,lyr_OpenRailWayMapStandard_6];
